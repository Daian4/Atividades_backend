create database supermercado_online;
...
create table itens_do_pedido (
  ...
  quantidade integer not null references pedido(id),
...
values
('Mamão', 'Rico em vitaminaA potássio e vitamina C', 300, 123, 1),
('Maça', 'Fonte de potássio e fibras', 90, 34, 1),
('Cebola', 'Rico em quercetina, antocianinas, vitaminas do complexo B, C', 50, 76, 2),
('Abacate', 'NÃO CONTÉM GLÚTEM', 160, 64, 1),
('Tomate', 'Rico em vitaminas A, C e C', 125, 88, 2),
('Acelga', 'NÃO CONTÉM GLÚTEM',	235, 13, 2),
('Macarrão parafuso', 'Sêmola de trigo enriquecida com ferro e ácido fólico, ovos e conrantes naturais', 690, 5, 3),
('Massa para lasanha','Uma reunião de família precisa ter comida boa e muita alegria', 875, 19, 3),
('Refrigerante coca cola lata', 'Sabor original', 350, 189, 4),
('Refrigerante pepsi 2l','NÃO CONTÉM GLÚTEM. NÃO ALCOÓLICO', 700, 12, 4),
...
('Manga','Rico em Vitamina A, potássio e vitamina C', 198, 175, 1),
('Uva','NÃO CONTMÉ GLÚTEN', 420, 90, 1);
